...
namespace Xamarin.TTTAttributedLabel
{
	...
	//	byte [] TTTAttributedLabelVersionString { get; }
	//}

	[Static]
	//[Verify (ConstantsInterfaceAssociation)]
	interface TTTAttributeNames
	{
	...
	//interface TTTAttributedLabelProtocal
	//{
	...
	//partial class TTTAttributedLabel
	//{
	...
	interface TTTAttributedLabel : IUIGestureRecognizerDelegate
	{
		...
		// @property (assign, nonatomic) NSTextCheckingTypes dataDetectorTypes __attribute__((deprecated("")));
		...
		// @property (assign, nonatomic) CGFloat leading __attribute__((deprecated("")));
		[Export ("leading")]
		...
		// @property (nonatomic, strong) NSString * truncationTokenString __attribute__((deprecated("")));
		[Export ("truncationTokenString", ArgumentSemantic.Strong)]
		string TruncationTokenString { get; set; }

		// @property (nonatomic, strong) NSDictionary * truncationTokenStringAttributes __attribute__((deprecated("")));
